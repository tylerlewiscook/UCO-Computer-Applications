...
This example assignment examines the `Hitters` dataset in the `ISLR2` package.  To begin, make sure the `ISLR2` package is installed and run the following code:
```{r}
library(ISLR2)
```
